...
pub struct ChatgptExportResponse {
    ...
    pub rejected_messages: usize,
    pub privacy_screened_messages: usize,
    pub created: usize,
    pub existing_messages: usize,
...
pub fn run(service: &Service, params: ChatgptExportParams<'_>) -> Result<ChatgptExportResponse> {
    ...
    Ok(ChatgptExportResponse {
        ...
        unsupported_messages: skipped_total,
        rejected_messages: rejected_total,
        privacy_screened_messages: rejected_total,
        created,
        existing_messages: skipped_existing,
        skipped_existing,
